...
from radloader.ess import EdIELoader, EdIEDataset
...
class DataPath(object):
    ...
    def output_folder(self):
        return os.path.join(self.experiment_folder, DataPath.OUT_FOLDER)

    @property
    def model_path(self):
        return os.path.join(self.experiment_folder, DataPath.MODEL_FILE)

    @property
    def blueprint_path(self):
        return os.path.join(self.experiment_folder, DataPath.BP_FILE)
